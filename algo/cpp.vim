...
silent! normal! zE
let &fdl = &fdl
let s:l = 86 - ((32 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 86
...
silent! normal! zE
let &fdl = &fdl
let s:l = 23 - ((0 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 23
...
silent! normal! zE
let &fdl = &fdl
let s:l = 43 - ((37 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 43
...
silent! normal! zE
let &fdl = &fdl
let s:l = 56 - ((44 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 56
...
silent! normal! zE
let &fdl = &fdl
let s:l = 60 - ((3 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 60
...
exe 'vert 1resize ' . ((&columns * 130 + 129) / 258)
exe '2resize ' . ((&lines * 49 + 31) / 63)
exe 'vert 2resize ' . ((&columns * 127 + 129) / 258)
argglobal
balt stack_min.cc
setlocal keymap=
setlocal noarabic
...
silent! normal! zE
let &fdl = &fdl
let s:l = 26 - ((14 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 26
...
wincmd w
argglobal
if bufexists("zig_zag.cc") | buffer zig_zag.cc | else | edit zig_zag.cc | endif
balt stack_min.cc
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 44 - ((0 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 44
...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 56 + 31) / 63)
exe '2resize ' . ((&lines * 3 + 31) / 63)
argglobal
balt zig_zag.cc
...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 53 + 31) / 63)
exe '2resize ' . ((&lines * 6 + 31) / 63)
argglobal
balt future.cc
onoremap <buffer> C :call pymode#motion#select_c('^\s*class\s', 0)
vnoremap <buffer> <silent> K :call pymode#doc#show(@*)
...
badd +1 printf.cc
badd +1 malloc.cc
badd +1 sub_string.cc
badd +1 evil_input.cc
badd +1 2d_array.cc
badd +1 stack_min.cc
badd +1 zig_zag.cc
badd +1 zig_zag.py
...
badd +1 bfs.cc
badd +0 spinlock.cc
badd +62 stack_max.cc
badd +12 align.cc
badd +7 ~/.vimrc
badd +0 future.cc
badd +0 cnn.py
badd +15 stack_array.cc
badd +0 queue_array.cc
badd +0 matrix.cc
badd +0 sudoku.cc
badd +0 producer_consumer.cc
